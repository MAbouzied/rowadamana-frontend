...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    pushLeadInteraction("contact_form", "contact_page");
    const text = encodeURIComponent(
      `الاسم: ${formState.name}\nرقم الهاتف: ${formState.phone}\nالرسالة: ${formState.message}`
    );
    window.open(`https://wa.me/${CONTACT.whatsapp.replace(/\D/g, "")}?text=${text}`, "_blank");
  };
      ...
      <section className="py-16 md:py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-slate-300 text-lg max-w-2xl mx-auto">
            نحن نهتم بملاحظاتك واستفساراتك ونسعد بمساعدتك فيما يتعلق بخدماتنا ومنتجاتنا
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-slate-100">
              <h2 className="font-cairo font-bold text-2xl text-slate-900 mb-8">
                أرسل استفسارك
              </h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-500 hover:bg-amber-600 text-white py-4 rounded-xl font-bold text-lg transition-all shadow-lg hover:shadow-amber-500/30"
                >
                  إرسال الرسالة
                </button>
              </form>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-3xl shadow-xl p-8 border border-slate-100">
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-bold text-slate-900">هاتف</p>
              ...
              <div className="rounded-2xl overflow-hidden shadow-xl border border-slate-200 h-[400px]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3624.0!2d46.7!3d24.7!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2f03890d489399%3A0xba974d1c98e79fd5!2sRiyadh!5e0!3m2!1sen!2ssa!4v1710000000000"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
