      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm mb-6">
            ...
            <span className="font-semibold text-slate-700">تقييمات Google</span>
          </div>
          <h2 className="font-cairo text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 mb-4">
            ماذا يقول عملاؤنا
          </h2>
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            آراء عملائنا الحقيقيين من تقييمات Google
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {GOOGLE_REVIEWS.map((review, i) => (
            <article
              key={i}
              className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:border-amber-500/20 transition-all"
            >
